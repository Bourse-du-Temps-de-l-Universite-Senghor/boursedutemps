...
const ServicesPage: React.FC<ServicesPageProps> = ({ user, services, onAdd, onBuy }) => {
    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
        ...
        <div className="flex w-full md:w-auto gap-4">
          ...
          />
          <button 
            onClick={() => user ? setShowAdd(true) : alert('Connectez-vous pour ajouter un service')}
      ...
      {showAdd && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-lg rounded-3xl p-8 shadow-2xl">
            <h2 className="font-heading text-2xl font-bold mb-6 text-slate-800">Proposer un Service</h2>
